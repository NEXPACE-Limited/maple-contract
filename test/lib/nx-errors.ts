export default {
  ...
  NextMeso: {
    wrongValue: /^NextMeso\/wrongValue:/,
    wrongAmount: /^NextMeso\/wrongAmount:/,
    transferFailed: /^NextMeso\/transferFailed:/,
  },
  MaplestoryEquip: {
    burnForbidden: /^MaplestoryEquip\/burnForbidden:/,
    setLimitSupply: /^MaplestoryEquip\/setLimitSupply:/,
    mintInvalidItem: /^MaplestoryEquip\/mintInvalidItem:/,
    ...
    tokenNotExists: /^MaplestoryEquip\/tokenNotExists:/,
    itemNotExists: /^MaplestoryEquip\/itemNotExists:/,
  },
  MaplestoryConsume: {
    burnForbidden: /^MaplestoryConsume\/burnForbidden:/,
    setLimitSupply: /^MaplestoryConsume\/setLimitSupply:/,
    setSupplyOverflow: /^MaplestoryConsume\/setSupplyOverflow:/,
    mintInvalidTokenID: /^MaplestoryConsume\/mintInvalidTokenID:/,
    overMint: /^MaplestoryConsume\/overMint:/,
    amountOverflow: /^MaplestoryConsume\/amountOverflow:/,
    invalidRequest: /^MaplestoryConsume\/invalidRequest:/,
    tokenNotExists: /^MaplestoryConsume\/tokenNotExists:/,
    issuedLimit: /^MaplestoryConsume\/issuedLimit:/,
  },
  MaplestoryEquipSBT: {
    tokenNotExists: /^MaplestoryEquipSBT\/tokenNotExists:/,
    setLimitSupply: /^MaplestoryEquipSBT\/setLimitSupply:/,
    uriInvalidID: /^MaplestoryEquipSBT\/uriInvalidID:/,
    ownerOfInvalidID: /^MaplestoryEquipSBT\/ownerOfInvalidID:/,
    mintInvalidItem: /^MaplestoryEquipSBT\/mintInvalidItem:/,
    NotTransferable: /^MaplestoryEquipSBT\/NotTransferable:/,
    itemNotExists: /^MaplestoryEquipSBT\/itemNotExists:/,
    invalidLength: /^MaplestoryEquipSBT\/invalidLength:/,
  },
  MaplestoryCharacter: {
    ...
    transferInvalidID: /^MaplestoryCharacter\/transferInvalidID:/,
    withdrawForbidden: /^MaplestoryInventory\/withdrawForbidden:/,
  },
  NextForwarder: {
    duplicate: /^NextForwarderCore\/duplicate:/,
    deadline: /^NextForwarderCore\/deadline:/,
  },
};
